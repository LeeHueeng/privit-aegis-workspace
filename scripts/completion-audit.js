...
function main() {
  ...
  add(
    ...
    "Target advisory includes passive probes plus CORS, CSP quality, client bundle leakage, source maps, API docs, admin/debug surfaces, metafiles, error disclosure, HTTP methods, and TLS posture.",
