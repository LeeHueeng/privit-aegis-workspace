...
function main() {
  ...
  add(
    ...
    "Target advisory includes passive probes plus CORS, CSP quality, client bundle leakage, backup/extension exposure, directory listings, source maps, API docs, admin/debug surfaces, metafiles, error disclosure, HTTP methods, header misconfiguration, and TLS posture.",
